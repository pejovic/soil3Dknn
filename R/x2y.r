...
#' @param y_hat PARAM_DESCRIPTION
#' @param y_actual PARAM_DESCRIPTION
...
#'  }
#' }
#' @rdname calc_misclass_reduction
...
#' @param x PARAM_DESCRIPTION
#' @param y PARAM_DESCRIPTION
#' @param confidence PARAM_DESCRIPTION, Default: FALSE
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples 
#' \dontrun{
...
#' @param target PARAM_DESCRIPTION, Default: NA
#' @param confidence PARAM_DESCRIPTION, Default: FALSE
#' @return OUTPUT_DESCRIPTION
#' @details DETAILS
#' @examples 
